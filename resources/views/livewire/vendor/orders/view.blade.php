<div>
    ...
    <x-dashboard.page-header>
        ...
        <div class="text-sm font-normal">
            {{$orders->user_type}} <i class="mx-2 fas fa-arrow-right"></i> {{ $orders->belongs_to_type}}
        </div>

        <div class="flex items-center text-xs sapce-x-2">
            {{$orders->delevery }} Delvevery <i class="px-2 fas fa-caret-right"></i> {{$orders->area_condition ==
    ...
    <x-dashboard.container>
        <x-dashboard.section>
                ...
                <div class="p-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-primary-button wire:click="$dispatch('open-modal', 'rider-assign-modal')">
                            <i class="pr-2 fas fa-plus"></i> Rider
                        </x-primary-button>
                        @endif
            ...
            <div class="flex items-center justify-end mt-2 space-x-2">
                ...
                <x-primary-button>
                    <i class="pr-2 fas fa-truck-fast"></i> Rider Assigned
                </x-primary-button>
                @endif
        ...
        <x-dashboard.section>
            <div class="flex items-start justify-between px-5 mb-2">
                <div class="order-info">
                    @if($orders->received_at !== null)
                        <p class="inline-block text-xs text-white bg-green-500 rounded px-1 py-0.5 mb-1.5" >
                            <i class="far fa-check-circle mr-0.5" ></i>
                            <span class="font-medium" >{{ __('Received') }}</span>
                        </p>
                    @endif
                    ...
                    <table class="table">
                        <tr>
                            <p class="flex flex-col" >
                                ...
                                <span>{{$orders->location}}</span>
                            </p>
                            <p>
                                <span>{{ __('House-' ) . ($orders->house_no ?? "N/A") }}</span>
                                <span>, </span>
                                <span>{{ __('Road-' ) . ($orders->road_no ?? "N/A") }}</span>
                            </p>
                            <p>{{$orders->number}}</p>
                        </tr>
                        <tr>
            ...
            <x-dashboard.table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center space-x-1 text-xs">
                                ...
                                Resel
                                @else
                                <span class="px-2 text-white bg-indigo-900 rounded-lg text-md"> You </span>
                                @endif
                                ...
                                @else
                                <button class="p-2 text-xs border rounded" type="button"
                                    wire:click.prevent="syncOrder({{$item->id}})">
                                    <i class="pr-2 fas fa-angle-right"></i> Link to Vendor
                                </button>
                                @endif
                                @endif
                            </div>
                ...
                <tfoot>
                    ...
                    <tr class="text-lg font-bold bg-gray-100 border-t">
