<div class="max-w-3xl mx-auto p-6 bg-white shadow rounded-xl" >
        ...
        <div class="text-center py-10">
            ...
            <div class="mt-4">
                <span class="px-4 py-2 rounded bg-yellow-100 text-yellow-800">
                    Status: {{ ucfirst($managementRequest->status ?? 'pending') }}
                </span>
            </div>
            ...
            @elseif($managementRequest->status === 'rejected')
    ...
    @else
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Management Partnership Form</h2>
