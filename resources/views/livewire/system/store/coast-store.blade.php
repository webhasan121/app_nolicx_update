<div x-init="$wire.getDeta()" >
  <div class="rounded bg-white text-center" x-loading.disabled>
    <div class="border border-green-900 rounded md:flex justify-between items-center p-2" >
      ...
      <div class="px-3 py-1 lg:p-3 text-sm font-bold " style="color:green;" >
        <span>{{$store}}</span>
      </div>
    </div>
  </div>
  ...
  <div class="relative mt-2">
    <button wire:click="withdraw2" class="inline-block bg-blue-500 hover:bg-blue-600 rounded-md px-3 py-1">
      <span class="text-sm text-white font-bold" >{{ __('Withdraw') }}</span>
    </button>
  </div>

  <x-modal name="withdrawModal2" maxWidth="md" >
