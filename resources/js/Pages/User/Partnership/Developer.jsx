...
export default function Developer() {
    const { name, email, phone, hasApplied, developerRequest } = usePage().props;
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("user.developer.apply"));
    };
