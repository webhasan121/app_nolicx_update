...
export default function Edit() {
    ...
    const save = (e) => {
        e.preventDefault();
        form.post(route("system.products.update", { product: productData.id }), {
            forceFormData: true,
        });
    };

    const moveToTrash = () => {
        router.post(route("system.products.trash", { product: productData.id }));
    };

    const restoreFromTrash = () => {
        router.post(route("system.products.restore", { product: productData.id }));
    };

    const eraseOldImage = (imageId) => {
        router.delete(
            route("system.products.images.destroy", {
