...
export default function ManagementTeam({ applications = { data: [] }, filters = {}, printUrl }) {
    ...
    const toggleStatus = (app) => {
        ...
        if (!window.confirm(`Are you sure you want to ${action} this management team user?`)) {
            return;
        }
    ...
    return (
        <AppLayout
            title="Partnership - Management TM"
            header={<PageHeader>Partnership - Management TM</PageHeader>}
        >
            <Head title="Partnership - Management TM" />
