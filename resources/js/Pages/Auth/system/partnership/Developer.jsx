...
export default function Developer({ applications = { data: [] }, filters = {}, printUrl }) {
    ...
    const toggleStatus = (app) => {
        ...
        if (!window.confirm(t("Are you sure you want to :action this developer?", { action }))) {
            return;
        }
    ...
    return (
        <AppLayout
            title={t("Partnership - Developer Access")}
            header={<PageHeader>{t("Partnership - Developer Access")}</PageHeader>}
        >
            <Head title={t("Partnership - Developer Access")} />
